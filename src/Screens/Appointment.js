...
// import { Text, View, TouchableOpacity, TextInput, ImageBackground, SafeAreaView, StyleSheet, Image, ScrollView } from "react-native";
...
//     return (
//         <SafeAreaView >
//             <ImageBackground source={require('../assets/background-image2.png')}>
//                 <ScrollView>
//                     <View >
//                         <View >
//                             <TextInput
...
export default function Appointment() {
    ...
    const handleSubmit = async () => {
        try {
            const response = await axios.post('https://jewellery-bliss.onrender.com/api/bookings/make', {
                            ...
                            <View>
                                <TouchableOpacity onPress={showDatePicker} activeOpacity={0.8}>
                                    <View style={{ alignItems: "center", marginTop: moderateScaleVertical(20) }}>
                                        ...
                                        <Image source={require("../assets/Appointment.png")} style={{ width: 30, height: 30 }} />
