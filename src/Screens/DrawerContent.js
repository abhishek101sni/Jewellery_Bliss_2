            ...
            <ScrollView>
                ...
                <View style={{ marginTop: moderateScaleVertical(50), flexDirection: "row", justifyContent: "space-around", marginHorizontal: moderateScale(50) }}>
                    <TouchableOpacity onPress={() => {
                        ...
                        <Image source={require("../assets/SocialMediaIcons/facebook.png")} style={{ width: moderateScale(31), marginTop: moderateScaleVertical(3), height: moderateScaleVertical(32) }} />
                    </TouchableOpacity>

                    <TouchableOpacity onPress={() => {
                        Linking.openURL("https://www.instagram.com/");
                    }}>
                        <Image source={require("../assets/SocialMediaIcons/instagram.png")} style={{ width: moderateScale(32), marginTop: moderateScaleVertical(3), height: moderateScaleVertical(32), tintColor: "black", }} />
                    </TouchableOpacity>

                    <TouchableOpacity onPress={() => { Linking.openURL('whatsapp://send?text=Hii Jwellery Bliss&phone=9818287083') }}>
                        <Image source={require("../assets/SocialMediaIcons/whatsapp.png")} style={{ width: moderateScale(36), height: moderateScaleVertical(37), marginBottom: moderateScaleVertical(5) }} />
                    </TouchableOpacity>
                </View>
