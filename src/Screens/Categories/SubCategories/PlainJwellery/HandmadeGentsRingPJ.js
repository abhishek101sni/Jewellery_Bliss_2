...
const HandmadeGentsRingPJ = ({ navigation }) => {
  const [data, setData] = useState([]);
  const dispatch = useDispatch();

  const getAPIDATA = async () => {
    const url = "https://bliss-app-backend-production.up.railway.app/api/products/?search=Handmade%20Gents%20ring";
...
export default HandmadeGentsRingPJ
