...
const RodiumChainsC = ({navigation}) => {
  // WhatsApp
  ...
  const getAPIDATA = async () => {
    const url =
      'https://bliss-app-backend-production.up.railway.app/api/products/?search=Rodium';
      ...
      <ImageBackground
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <Menu
            ...
            trigger={triggerProps => {
              return (
                <Pressable
                  ...
                  {...triggerProps}>
                  <Text>Select purity</Text>
                </Pressable>
              );
            }}>
            <Menu.Item
              onPress={() => {
                const filtered = data.filter(item => item.purity == 18);
            ...
            <Menu.Item
              onPress={() => {
                const filtered = data.filter(item => item.purity == 20);
                console.log('FILTERED DATA', filtered);
                //setFilteredData(filtered);
                setVisibleData(filtered);
              }}>
            ...
            <Menu.Item
              onPress={() => {
                const filtered = data.filter(item => item.purity == 22);
                console.log('FILTERED DATA', filtered);
                //setFilteredData(filtered);
                setVisibleData(filtered);
              }}>
          ...
          <Menu
            ...
            <Menu.Item
              onPress={() => {
                const filtered = data.filter(item => item.weight == 4.00);
                console.log('FILTERED DATA', filtered);
                //setFilteredData(filtered);
                setVisibleData(filtered);
              }}>
        ...
        <FlatList
          ...
          extraData={filteredData || visibleData}
