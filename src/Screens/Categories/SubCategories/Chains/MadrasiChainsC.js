...
//     const url =
//       'https://bliss-app-backend-production.up.railway.app/api/products/?search=';
...
const MadrasiChainsC = () => {
  return (
    <View>
      <Text>No data in madarasi chains</Text>
    </View>
  )
}

export default MadrasiChainsC
