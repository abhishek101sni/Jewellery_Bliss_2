...
const HollowNawabiChainsC = ({navigation}) => {
  // WhatsApp
  ...
  const getAPIDATA = async () => {
    const url = "https://bliss-app-backend-production.up.railway.app/api/products/?search=Rodium%2010g";
...
export default HollowNawabiChainsC;
