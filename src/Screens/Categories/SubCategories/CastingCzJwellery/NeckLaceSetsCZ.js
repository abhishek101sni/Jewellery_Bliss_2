...
const NeckLaceSetsCZ = ({navigation}) => {
...
// WhatsApp
  ...
  const getAPIDATA = async () => {
    // const url = "https://bliss-app-backend-production.up.railway.app";
    const url = "https://bliss-app-backend-production.up.railway.app/api/products/?search=Necklace%20Set";
