...
const GentsSolitairRingsCZ = ({ navigation }) => {
  const [data, setData] = useState([]);
  const dispatch = useDispatch();

  const getAPIDATA = async () => {
    const url = "https://bliss-app-backend-production.up.railway.app/api/products/?search=Gents%20Solitaire%20Ring";
...
export default GentsSolitairRingsCZ
