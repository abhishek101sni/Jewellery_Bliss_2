...
// const GentsRingsCZ = ({ navigation }) => {
//   const [data, setData] = useState([]);
//   const dispatch = useDispatch();

//   const getAPIDATA = async () => {
//     const url = "https://bliss-app-backend-production.up.railway.app/api/products/?search=Gents%20Ring";
...
// import React, {useState, useEffect} from 'react';
// import { View, Text, Image, TouchableOpacity, ScrollView, FlatList, ImageBackground, SafeAreaView, Button, Modal, TextInput} from 'react-native';
// import {useDispatch} from 'react-redux';
// import {setActiveItem} from '../../../../redux/action';
// import {StyleSheet} from 'react-native';
...
//   const getAPIDATA = async () => {
//     const url = 'https://jewellery-bliss.onrender.com/api/products?search=Silky%20Rope';
//     let result = await fetch(url);
//     result = await result.json();
//     setData(result);
//   };
