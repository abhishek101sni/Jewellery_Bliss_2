...
const CockTailRingsCZ = ({navigation}) => {
...
// WhatsApp
  ...
  const getAPIDATA = async () => {
    const url = "https://jewellery-bliss.onrender.com/api/products?searchPurity=22&search=Cocktail%20Ring";
...
export default CockTailRingsCZ;
