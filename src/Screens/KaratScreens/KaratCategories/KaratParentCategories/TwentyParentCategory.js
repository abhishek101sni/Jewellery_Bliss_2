...
const TwentyParentCategory = ({navigation}) => {
  const ParentCategoryData = [
    ...
    },
    {
        ...
        onPress: () => {
            navigation.navigate("PlainJewelleryT");
        },
    ...
    },
    {
        ...
        onPress: () => {
            navigation.navigate("CastingJewelleryT");
        },
...
export default TwentyParentCategory
