...
const TwentyTwoParentCategory = ({navigation}) => {
  const ParentCategoryData = [
    ...
    },
    {
        ...
        onPress: () => {
            navigation.navigate("PlainJewelleryTT");
        },
    ...
    },
    {
        ...
        onPress: () => {
            navigation.navigate("CastingJewelleryTT");
        },
    ...
    },
    {
        ...
        onPress: () => {
            navigation.navigate("CastingCZJewelleryTT");
        },
...
export default TwentyTwoParentCategory
