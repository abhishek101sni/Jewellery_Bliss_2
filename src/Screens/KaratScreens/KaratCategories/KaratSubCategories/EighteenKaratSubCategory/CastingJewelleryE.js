...
const CastingJewelleryE = ({ navigation }) => {
  ...
  const CastingData = [
    {
      ...
      onPress: () => {
        navigation.navigate("LadiesRingSubSubCJE");
      },
      title: "Ladies Rings"
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("GentsRingSubSubCJE");
      },
      title: "Gents Rings",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("PendentsSubSubCJE");
      },
      title: "Pendents",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("TopsSubSubCJE");
      },
      title: "Tops",
    },
    {
      img: require('../../../../../assets/PRODUCTS/CHAINS/Categories/castingJewellery/tops.jpg'),
      onPress: () => {
        navigation.navigate("GodPendentsSubSubCJE");
      },
      title: "God Pendents",
    },
...
export default CastingJewelleryE
