...
const CastingCZJewelleryT = ({ navigation }) => {
  ...
  const CastingCzData = [
    {
      ...
      img: require('../../../../../assets/MoodShots/10.jpg'),
      onPress: () => {
        navigation.navigate("NeckLaceSetsSubSubCZT");
      },
      title: "Necklace Sets"
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate('MangalSutraSubSubCZT');
      },
      title: "Mangal Sutra",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("LadiesRingsSubSubCZT");
      },
      title: "Ladies Rings",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("CockTailRingsSubSubCZT");
      },
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("LadiesSolitaireRingsSubSubCZT");
      },
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("GentsRingsSubSubCZT");
      },
      title: "Gents Rings",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("GentsSolitairRingsSubSubCZT");
      },
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("TopsSubSubCZT");
      },
      title: "Tops",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("SolitaireTopsSubSubCZT");
      },
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("PendentSetsSubSubCZT");
      },
      title: "Pendent Sets",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("SolitairePendentSetsSubSubCZT");
      },
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("CharmsSubSubCZT");
      },
      title: "Charms",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("GodPendentsSubSubCZT");
      },
      title: "God Pendents",
    },
    {
      img: require('../../../../../assets/coming_soon.png'),
      onPress: () => {
        navigation.navigate("BraceLetsSubSubCZT");
      },
      title: "Bracelets",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("BaliSubSubCZT");
      },
      title: "Bali",
    },
...
export default CastingCZJewelleryT
