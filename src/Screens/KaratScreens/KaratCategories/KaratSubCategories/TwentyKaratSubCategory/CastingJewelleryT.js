...
const  CastingJewelleryT = ({ navigation }) => {
  ...
  const CastingData = [
    {
      ...
      onPress: () => {
        navigation.navigate("LadiesRingSubSubCJT");
      },
      title: "Ladies Rings"
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("GentsRingSubSubCJT");
      },
      title: "Gents Rings",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("PendentsSubSubCJT");
      },
      title: "Pendents",
    },
    {
      ...
      onPress: () => {
        navigation.navigate("TopsSubSubCJT");
      },
      title: "Tops",
    },
    {
      img: require('../../../../../assets/PRODUCTS/CHAINS/Categories/castingJewellery/tops.jpg'),
      onPress: () => {
        navigation.navigate("GodPendentsSubSubCJT");
      },
      title: "God Pendents",
    },
...
export default CastingJewelleryT
