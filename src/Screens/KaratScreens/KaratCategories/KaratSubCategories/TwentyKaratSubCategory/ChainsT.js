    ...
    const ChainsData = [
        {
          ...
          onPress: () => {
            navigation.navigate("SilkyChainsSubSubT");
          },
          title: "Silky Chains"
        ...
        // },
        {
          ...
          onPress: () => {
            navigation.navigate("RodiumChainsSubSubT");
          },
          title: "Rodium Chains",
        },
        {
          ...
          onPress: () => {
            navigation.navigate("KajuKatliChainsSubSubT");
          },
        ...
        },
        {
          ...
          onPress: () => {
            navigation.navigate("MachineChainsSubSubT");
        ...
        },
        {
          ...
          onPress: () => {
            navigation.navigate("SolidNawabiChainsSubSubT");
          },
        ...
        },
        {
          ...
          onPress: () => {
            navigation.navigate("HollowNawabiChainsSubSubT");
          },
        ...
        },
        {
          ...
          onPress: () => {
            navigation.navigate("MadrasiChainsSubSubT");
          },
        ...
        },
        {
          ...
          onPress: () => {
            navigation.navigate("HandmadeChainsSubSubT");
          },
        ...
        },
        {
          ...
          onPress: () => {
            navigation.navigate("HollowChainsSubSubT");
          },
          title: "Hollow Chains",
        },
        {
          ...
          onPress: () => {
            navigation.navigate("ChocoChainsSubSubT");
          },
          title: "Choco Chains",
        },
        {
          ...
          onPress: () => {
            navigation.navigate("IndoChocoChainsSubSubT");
          },
